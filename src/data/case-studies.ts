// Electric Sheep — case-study content (seeded from design-reference/js/data.js)
    ...
    sections: [
      {
        type: 'text',
        label: 'The challenge',
        body: 'Applications arrived by post, moved by hand, and disappeared into filing cabinets. Growers waited weeks for answers that took minutes to make. Nobody could see where anything was.',
      },
      {
        type: 'image',
        src: '/assets/images/work-farm-jersey.png',
        caption: 'The grower portal — application status at a glance.',
      },
      {
        type: 'text',
        label: 'What we did',
        body: 'One portal for growers, one dashboard for the team. Structured applications, automated checks, and a status anyone can read. No training manual required.',
      },
      {
        type: 'text',
        label: 'The result',
        body: 'Same-day decisions on standard applications. Six weeks of admin, gone. The filing cabinets are now used for biscuits.',
      },
    ],
    quote: null,
  },
    ...
    sections: [
      {
        type: 'text',
        label: 'The challenge',
        body: 'The same clauses, typed again and again. Every document a fresh chance for a typo, and every typo a phone call.',
      },
      {
        type: 'image',
        src: '/assets/images/work-generic.jpg',
        caption: 'Template engine — one source of truth per clause.',
      },
      {
        type: 'text',
        label: 'What we did',
        body: 'A template engine driven by structured data, with AI handling the boring parts and a human signing off on the important ones. Automated by AI. Driven by people.',
      },
      {
        type: 'text',
        label: 'The result',
    ...
    sections: [
      {
        type: 'text',
        label: 'The challenge',
        body: 'Client onboarding meant re-keying the same details into four systems. Skilled people were doing unskilled work, and the backlog showed it.',
      },
      {
        type: 'image',
        src: '/assets/images/work-generic.jpg',
        caption: 'Intake pipeline — four systems, one entry point.',
      },
      {
        type: 'text',
        label: 'What we did',
        body: 'A single intake flow feeding every system at once, with AI-assisted document checks and clear handoffs to humans wherever a decision matters.',
      },
      {
        type: 'text',
        label: 'The result',
    ...
    sections: [
      {
        type: 'text',
        label: 'The challenge',
        body: 'A new venture with serious ambitions and nothing to show for it yet. The brand had to earn trust before the track record could.',
      },
      {
        type: 'image',
        src: '/assets/images/testimonial-virdaris.png',
        caption: 'Identity system — built to hold up in serious rooms.',
      },
      {
        type: 'text',
        label: 'What we did',
        body: 'Strategy first, then identity, then product. One design system carried the brand from pitch deck to client portal without changing its accent.',
      },
      {
        type: 'text',
        label: 'The result',
    ...
    sections: [
      {
        type: 'text',
        label: 'The challenge',
        body: 'Advisers chased documents by email while clients wondered what was happening. Everyone was busy. Nothing moved.',
      },
      {
        type: 'image',
        src: '/assets/images/testimonial-mortgage-shop.jpg',
        caption: 'Client portal — every application, one timeline.',
      },
      {
        type: 'text',
        label: 'What we did',
        body: 'A shared portal where clients upload once, advisers see everything, and the system does the chasing. Progress you can actually look at.',
      },
      {
        type: 'text',
        label: 'The result',
...
export function getCaseStudy(id: string): CaseStudy {
  return CASE_STUDIES.find((c) => c.id === id) ?? CASE_STUDIES[0];
}
